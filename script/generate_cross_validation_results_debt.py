...
PATH_TO_RESULTS_CROSS_PREDICTIONS_DEBT_WEEK = os.environ.get("PATH_TO_RESULTS_CROSS_PREDICTIONS_DEBT_WEEK")
...
cross_validator = CrossValidation(PATH_TO_DEBT_CROSS, PATH_TO_DEBT_VIDEO, PATH_TO_RESULTS_CROSS_PREDICTIONS_DEBT_WEEK)
